...
import { menuData, IMenuItem, SetSortMenu, TMenuItemCategory, ECategoryToParams } from '../lib';
...
export const CategoryNav = ({
  ...
  const categories: TMenuItemCategory[] = ['Donuts', 'Breakfast', 'Coffee & Drinks', 'All'];
  ...
  const filterMenuByCategory = (cat: TMenuItemCategory) => {
    ...
    if (cat === 'All' || cat === category) {
      ...
      setSortMenu(menuData.filter((menuItem: IMenuItem) => menuItem.category === category));
    }
  };
